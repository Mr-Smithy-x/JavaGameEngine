...
public abstract class SpriteSheetEntity implements Drawable, BoundingContract<Number>, MovableCollision {
    ...
    public SpriteSheetEntity(Game game, String name) throws IOException {
        this(game, name, .0f, .0f, 0, 0);
    }
    ...
    public SpriteSheetEntity(Game game, String name, float x, float y, int width, int height) throws IOException {
        this.game = game;
    ...
    public Image getImage() {
        ...
        //return spriteSheet.getSubimage(sub.getSpritePositionStartX(), sub.getSpritePositionStartY(), sub.getWidth(), sub.getHeight());
    }
    ...
    public Image getStillImage() {
        ...
        //     return spriteSheet.getSubimage(stillImage.getSpritePositionStartX(), stillImage.getSpritePositionStartY(), stillImage.getWidth(), stillImage.getHeight());
    }
