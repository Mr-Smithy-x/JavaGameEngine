package com.charlton.game.input;
...
public class GameKeyManager implements KeyListener {
    ...
    public void tick(){
        up = pressing[KeyEvent.VK_W] || pressing[UP];
        down = pressing[KeyEvent.VK_S] || pressing[DN];
        left = pressing[KeyEvent.VK_A] || pressing[LT];
        right = pressing[KeyEvent.VK_D] || pressing[RT];
    }
