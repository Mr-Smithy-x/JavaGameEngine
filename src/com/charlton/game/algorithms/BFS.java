...
public class BFS {
    ...
    public static boolean toCamera(TileMap tileSet, SpriteSheet sheet) {
        ...
        int scaled_tile_sheet_width = tile_sheet_width * GlobalCamera.scaling_factor;
        int scaled_tile_sheet_height = tile_sheet_height * GlobalCamera.scaling_factor;
        int scaled_sprite_sheet_position_x = sprite_sheet_position_x * GlobalCamera.scaling_factor;
        int scaled_sprite_sheet_position_y = sprite_sheet_position_y * GlobalCamera.scaling_factor;
        ...
        double position_x = GlobalCamera.x; // Destination
        double position_y = GlobalCamera.y; //Desition
